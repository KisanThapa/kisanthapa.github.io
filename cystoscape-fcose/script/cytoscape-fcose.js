  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        auxiliary.connectComponents = function (
          cy,
          eles,
          topMostNodes,
          dummyNodes
            ...
            var _loop2 = function _loop2() {
              ...
              currentNode
                ...
                .forEach(function (node) {
                  if (
                    eles.intersection(currentNode.edgesWith(node)).length > 0
                  ) {
              ...
              for (var i = 0; i < neighborNodes.length; i++) {
                ...
                if (
                  ...
                  !visited.has(currentNeighbor[0])
                ) {
                  var childrenOfNeighbor = currentNeighbor.union(
          ...
          if (dummyNodes) {
            if (nodesConnectedToDummy.length > 0) {
              dummyNodes.set(
                "dummy" + (dummyNodes.size + 1),
                nodesConnectedToDummy
              );
            }
          }
          return components;
        ...
        auxiliary.calcBoundingBox = function (
          parentNode,
          xCoords,
          yCoords,
          nodeIndexes
          ...
          for (var i = 0; i < s; i++) {
            ...
            nodeBottom =
              yCoords[nodeIndexes.get(node.id())] + node.height() / 2;
              ...
              value: function run() {
                ...
                if (eles.nodes().length > 0) {
                  ...
                  if (!packingEnabled) {
                    ...
                    // packing is enabled
                    var topMostNodes = aux.getTopMostNodes(
                      options.eles.nodes()
                    );
                    components = aux.connectComponents(
                      cy,
                      options.eles,
                      topMostNodes
                    );
                    ...
                    if (
                      ...
                      if (options.tile) {
                        ...
                        components.forEach(function (component, index) {
                          if (component.edges().length == 0) {
                            component.nodes().forEach(function (node, i) {
                              ...
                              if (!node.isParent()) {
                                tempSpectralResult.nodeIndexes.set(
                                  component.nodes()[i].id(),
                                  count++
                                );
                                tempSpectralResult.xCoords.push(
                                  component.nodes()[0].position().x
                                );
                                tempSpectralResult.yCoords.push(
                                  component.nodes()[0].position().y
                                );
                              }
                            });
                        ...
                        if (toBeTiledNodes.length > 1) {
                          ...
                          for (
                            var i = indexesToBeDeleted.length - 1;
                            i >= 0;
                            i--
                          ) {
                      ...
                      components.forEach(function (component, index) {
                        ...
                        options.eles = component;
                        coseResult.push(
                          coseLayout(options, spectralResult[index])
                        );
                      });
                    }
                    ...
                    if (components.length > 1) {
                        ...
                        component.nodes().forEach(function (node) {
                          if (options.quality == "draft") {
                            if (!node.isParent()) {
                              ...
                              subgraph.nodes.push({
                                x:
                                  spectralResult[index].xCoords[nodeIndex] -
                                  node.boundingbox().w / 2,
                                y:
                                  spectralResult[index].yCoords[nodeIndex] -
                                  node.boundingbox().h / 2,
                                width: node.boundingbox().w,
                                height: node.boundingbox().h,
                              });
                            } else {
                              var parentInfo = aux.calcBoundingBox(
                                node,
                                spectralResult[index].xCoords,
                                spectralResult[index].yCoords,
                                nodeIndexes
                              );
                              subgraph.nodes.push({
                        ...
                        component.edges().forEach(function (edge) {
                          ...
                          if (options.quality == "draft") {
                            ...
                            if (source.isParent()) {
                              ...
                              sourceCenter.push(
                                parentInfo.topLeftX + parentInfo.width / 2
                              );
                              sourceCenter.push(
                                parentInfo.topLeftY + parentInfo.height / 2
                              );
                            } else {
                              sourceCenter.push(
                                spectralResult[index].xCoords[sourceNodeIndex]
                              );
                              sourceCenter.push(
                                spectralResult[index].yCoords[sourceNodeIndex]
                              );
                            }
                            if (target.isParent()) {
                              var _parentInfo = aux.calcBoundingBox(
                                target,
                                spectralResult[index].xCoords,
                                spectralResult[index].yCoords,
                                nodeIndexes
                              ...
                              targetCenter.push(
                                _parentInfo.topLeftX + _parentInfo.width / 2
                              );
                              targetCenter.push(
                                _parentInfo.topLeftY + _parentInfo.height / 2
                              );
                            } else {
                              targetCenter.push(
                                spectralResult[index].xCoords[targetNodeIndex]
                              );
                              targetCenter.push(
                                spectralResult[index].yCoords[targetNodeIndex]
                              );
                            }
                            subgraph.edges.push({
                            ...
                            subgraph.edges.push({
                              startX:
                                coseResult[index][source.id()].getCenterX(),
                              startY:
                                coseResult[index][source.id()].getCenterY(),
                      ...
                      var shiftResult =
                        layUtil.packComponents(subgraphs).shifts;
                      if (options.quality == "draft") {
                        ...
                        coseResult.forEach(function (result, index) {
                          Object.keys(result).forEach(function (item) {
                            ...
                            nodeRectangle.setCenter(
                              nodeRectangle.getCenterX() +
                                shiftResult[index].dx,
                              nodeRectangle.getCenterY() + shiftResult[index].dy
                            );
                          });
                        });
                      }
                  ...
                  if (!options.fixedNodeConstraint) {
                    ...
                    if (options.quality == "draft") {
                      ...
                      var diffOnX =
                        boundingBox.x1 +
                        boundingBox.w / 2 -
                        (maxXCoord + minXCoord) / 2;
                      var diffOnY =
                        boundingBox.y1 +
                        boundingBox.h / 2 -
                        (maxYCoord + minYCoord) / 2;
                      spectralResult.forEach(function (result) {
                      ...
                      coseResult.forEach(function (result, index) {
                        Object.keys(result).forEach(function (item) {
                          var node = result[item];
                          node.setCenter(
                            node.getCenterX() + _diffOnX,
                            node.getCenterY() + _diffOnY
                          );
                        });
                      });
                    }
                ...
                if (
                  ...
                  eles
                    .nodes()
                    .not(":parent")
                    .layoutPositions(layout, options, getPositions);
                } else {
                  console.log(
...
*/
        ...
        var coseLayout = function coseLayout(options, spectralResult) {
          ...
          var processChildrenList = function processChildrenList(
            parent,
            children,
            layout,
            options
                  ...
                  if (!theChild.isParent()) {
                    theNode = parent.add(
                      new CoSENode(
                        layout.graphManager,
                        new PointD(
                          xCoords[nodeIndexes.get(theChild.id())] -
                            dimensions.w / 2,
                          yCoords[nodeIndexes.get(theChild.id())] -
                            dimensions.h / 2
                        ),
                        new DimensionD(
          ...
          var processConstraints = function processConstraints(
            layout,
            options
          ) {
            // get nodes to be fixed
            if (options.fixedNodeConstraint) {
              layout.constraints["fixedNodeConstraint"] =
                options.fixedNodeConstraint;
            }
            // get nodes to be aligned
            if (options.alignmentConstraint) {
              layout.constraints["alignmentConstraint"] =
                options.alignmentConstraint;
            }
        ...
        var spectralLayout = function spectralLayout(options) {
          ...
          var BFS = function BFS(pivot, index, samplingMethod) {
            ...
            if (samplingMethod) {
              for (var _i2 = 0; _i2 < nodeSize; _i2++) {
                if (C[_i2][index] < minDistancesColumn[_i2])
                  minDistancesColumn[_i2] = C[_i2][index];
              }
          ...
          var sample = function sample() {
            ...
            for (var i = 0; i < sampleSize; i++) {
              ...
              for (var j = 0; j < sampleSize; j++) {
                ...
                if (i == j) {
                  a_Sig[i][j] =
                    a_q[i] / (a_q[i] * a_q[i] + max_s / (a_q[i] * a_q[i]));
                }
              }
            }

            INV = Matrix.multMat(
              Matrix.multMat(a_v, a_Sig),
              Matrix.transpose(a_u)
            );
          };
          ...
          var powerIteration = function powerIteration() {
            ...
            while (true) {
              ...
              V2 = Matrix.minusOp(
                V2,
                Matrix.multCons(V1, Matrix.dotProduct(V1, V2))
              );
          ...
          try {
            for (
              var _iterator = dummyNodes.keys()[Symbol.iterator](), _step;
          ...
          parentNodes.forEach(function (ele) {
            ...
            parentChildMap.set(
              ele.id(),
              children.nodes(":childless")[index].id()
            );
          });
            ...
            ele
              ...
              .forEach(function (node) {
                if (eles.intersection(ele.edgesWith(node)).length > 0) {
                  if (node.isParent())
                    allNodesNeighborhood[eleIndex].push(
                      parentChildMap.get(node.id())
                    );
          ...
          try {
            for (
              var _iterator2 = dummyNodes.keys()[Symbol.iterator](), _step2;
          ...
          if (nodeSize > 2) {
            ...
            sampleSize =
              nodeSize < options.sampleSize ? nodeSize : options.sampleSize;
